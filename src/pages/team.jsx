...
function Teams() {
  ...
  const handleDelete = async (member_id)=>{
    ...
    const response = await request.deleteMember(member_id);
    if (response.status === 200) {
      console.log('deleted')
    }
              ...
              {teamMembers.map(member => (
                <tr key={member.member_id}>
                  ...
                  <td >
                    ...
                    <a href="" class="" >
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16" onClick={() => handleDelete(member.member_id)}>
